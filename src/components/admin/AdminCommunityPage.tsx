...
export function AdminCommunityPage() {
  ...
  const handleViewPost = (postId: string) => {
    toast.info(`Opening post ${postId} in detailed view...`);
  ...
  const handleTakeAction = (reportId: string) => {
    ...
    if (report) {
      toast.success(`Taking action on report: ${report.reason}`);
  ...
  const communityStats = [
    { title: 'Total Posts', value: '2,847', change: '+12%', icon: MessageSquare, color: 'text-blue-500' },
    { title: 'Pending Reports', value: '12', change: '+3', icon: Flag, color: 'text-red-500' },
    { title: 'Active Users', value: '1,423', change: '+8%', icon: Users, color: 'text-green-500' },
    { title: 'Daily Engagement', value: '89%', change: '+5%', icon: TrendingUp, color: 'text-[var(--sublimes-gold)]' },
  ];
        ...
        {posts.map((post) => (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <button 
                onClick={() => toast.info('More options menu...')}
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[var(--sublimes-card-bg)] border border-[var(--sublimes-border)] rounded-xl p-6">
          ...
          <p className="text-2xl font-bold text-[var(--sublimes-light-text)] mb-1">45</p>
        ...
        <div className="bg-[var(--sublimes-card-bg)] border border-[var(--sublimes-border)] rounded-xl p-6">
          ...
          <p className="text-2xl font-bold text-[var(--sublimes-light-text)] mb-1">2.3h</p>
