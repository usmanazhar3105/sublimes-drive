-- ============================================================================
-- URGENT FIX: Allow posting with images (without text)
-- Issue: posts.content column has NOT NULL constraint but RPC doesn't set it
-- ============================================================================
...
SELECT 'fn_create_post function updated successfully' AS status;
